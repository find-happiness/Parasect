...
public class SerTwo {
  ...
  public interface Iface {
     ...
     * @param query 查询条件
     */
    public List<SearchResult> search(Query query) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void search(Query query, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_search(Query query) throws org.apache.thrift.TException
    {
    ...
    public List<SearchResult> recv_search() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class search_call extends org.apache.thrift.async.TAsyncMethodCall {
      private Query query;
      public search_call(Query query, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public List<SearchResult> getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class search<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, search_args, List<SearchResult>> {
      public search() {
        super("search");
      }
      ...
      public AsyncMethodCallback<List<SearchResult>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<SearchResult>>() { 
          public void onComplete(List<SearchResult> o) {
            search_result result = new search_result();
            result.success = o;
            try {
      ...
      public void start(I iface, search_args args, org.apache.thrift.async.AsyncMethodCallback<List<SearchResult>> resultHandler) throws TException {
  ...
  public static class search_args implements org.apache.thrift.TBase<search_args, search_args._Fields>, java.io.Serializable, Cloneable, Comparable<search_args>   {
     ...
     * 查询条件
     */
    public search_args setQuery(Query query) {
      this.query = query;
      return this;
    }
  ...
  public static class search_result implements org.apache.thrift.TBase<search_result, search_result._Fields>, java.io.Serializable, Cloneable, Comparable<search_result>   {
    ...
    public List<SearchResult> success; // required
    ...
    public search_result(search_result other) {
      if (other.isSetSuccess()) {
        List<SearchResult> __this__success = new ArrayList<SearchResult>(other.success.size());
        for (SearchResult other_element : other.success) {
          __this__success.add(new SearchResult(other_element));
        }
    ...
    public java.util.Iterator<SearchResult> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(SearchResult elem) {
      if (this.success == null) {
        this.success = new ArrayList<SearchResult>();
      }
    ...
    public search_result setSuccess(List<SearchResult> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<SearchResult>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<SearchResult>(_list8.size);
                  for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                  {
                    SearchResult _elem10;
                    _elem10 = new SearchResult();
                    _elem10.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, search_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (SearchResult _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (SearchResult _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<SearchResult>(_list13.size);
            for (int _i14 = 0; _i14 < _list13.size; ++_i14)
            {
              SearchResult _elem15;
              _elem15 = new SearchResult();
              _elem15.read(iprot);
